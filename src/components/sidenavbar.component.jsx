...
const SideNav = () => {
  let {
    userAuth: { isAdmin, access_token, new_notification_available },
  ...
  return (
    <>
      {access_token === null ? (
        ...
        <section className="relative flex gap-10 py-0 m-8 max-md:flex-col">
          <div className="sticky top-[80px] z-30">
            <div className=" md:hidden bg-white py-1 border-b border-grey flex flex-nowrap overflow-x-auto">
              ...
              >
                <i className="fi fi-rr-chart-simple-horizontal pointer-events-none"></i>
              </button>
            ...
            <div
              className={
                ...
                (!showSideNav
                  ...
                  : "opacity-100 pointer-eveents-auto")
              }
            >
