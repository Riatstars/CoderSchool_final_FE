    ...
    <>
      ...
      <div className="flex gap-6 justify-between">
        <div className="flex gap-3 items-center">
          <button className="w-10 h-10 rounded-full flex justify-center items-center bg-grey/80">
            <i className="fi fi-rr-social-network"></i>
          </button>
          <p className="text-xl text-dark-grey">{total_likes}</p>

          <button className="w-10 h-10 rounded-full justify-center flex items-center bg-grey/80">
